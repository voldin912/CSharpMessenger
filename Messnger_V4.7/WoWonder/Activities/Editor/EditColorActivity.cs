    ...
    public class EditColorActivity : AppCompatActivity, INiceArt.IOnSaveListener, ITextEditor, INiceArt.IOnNiceArtEditorListener
    {
        ...
        private void InitBackPressed()
        {
            try
            {
                ...
                {
                    OnBackInvokedDispatcher.RegisterOnBackInvokedCallback(0, new BackCallAppBase2(this, "EditColorActivity"));
                }
                else
                {
                    OnBackPressedDispatcher.AddCallback(new BackCallAppBase1(this, "EditColorActivity", true));
                } 
            }
            catch (Exception e)
            {
