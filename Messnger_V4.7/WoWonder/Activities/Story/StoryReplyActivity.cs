...
namespace WoWonder.Activities.Story
{
    ...
    public class StoryReplyActivity : AppCompatActivity, DragToClose.IDragListener, IDialogListCallBack, IOnRecordClickListener, IOnRecordListener
    {
        ...
        private void EditTextOpen()
        {
            try
            {
                ChatMediaButton.SetImageResource(Resource.Drawable.icon_next_vector);
                    ...
                    case "attachment":
                        {
                            ...
                            dialogList.SetTitle(GetString(Resource.String.Lbl_Select_what_you_want));
