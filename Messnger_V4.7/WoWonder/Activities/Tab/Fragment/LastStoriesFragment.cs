...
{ 
    public class LastStoriesFragment : AndroidX.Fragment.App.Fragment 
    {
        ...
        private readonly ChatTabbedMainActivity ContextActivity;
        ...
        public LastStoriesFragment(ChatTabbedMainActivity context)
        {
        ...
        private void AddStoryLayout_Click(object sender, EventArgs e)
        {
            try
            {
                OptionsAddStoryBottomSheet bottomSheet = new OptionsAddStoryBottomSheet();
