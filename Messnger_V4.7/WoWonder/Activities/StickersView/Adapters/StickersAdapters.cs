...
namespace WoWonder.Activities.StickersView.Adapters
{
    public class StickersAdapters : RecyclerView.Adapter, ListPreloader.IPreloadModelProvider 
    {
        ...
        private SuggestionMessageAdapter TagsAdapter;
                    ...
                    { 
                        ...
                        case StickersModel.ItemTypeShop.RecommendedTag:
                        {
                            if (viewHolder is TemplateRecyclerViewHolder holder)
                            {
                                if (TagsAdapter == null)
                                {
                                    TagsAdapter = new SuggestionMessageAdapter(ActivityContext)
                                    {
                                        SuggestionMessagesList = new JavaList<SuggestionMessageAdapter.SuggestionMessages>()
                                    };
                                ...
                                {
                                    TagsAdapter.SuggestionMessagesList = new JavaList<SuggestionMessageAdapter.SuggestionMessages>();

                                    foreach (var tag in item.ListTags)
                                    {
                                        TagsAdapter.SuggestionMessagesList.Add(new SuggestionMessageAdapter.SuggestionMessages()
                                        {
                                            Message = tag,
                                            RealMessage = tag,
                                        });
