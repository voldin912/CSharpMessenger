...
namespace WoWonder.Activities.ChatWindow
{
    ...
    public class StartedMessagesActivity : BaseActivity, IDialogListCallBack
    {
                ...
                if (e.Position > -1)
                {
                    ...
                    if (SelectedItemPositions != null)
                    {
                        ...
                        if (AppSettings.EnablePinMessageSystem)
                            arrayAdapter.Add(SelectedItemPositions.MesData.Pin == "yes" ? GetText(Resource.String.Lbl_UnPin) : GetText(Resource.String.Lbl_Pin));
