...
{
    [Activity(Icon = "@mipmap/icon", Theme = "@style/MyTheme", Label = "Message",  Exported = true, ConfigurationChanges = ConfigChanges.Locale | ConfigChanges.UiMode | ConfigChanges.ScreenSize | ConfigChanges.Orientation | ConfigChanges.ScreenLayout | ConfigChanges.SmallestScreenSize)]
