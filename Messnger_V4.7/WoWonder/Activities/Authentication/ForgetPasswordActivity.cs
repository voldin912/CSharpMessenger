                            ...
                            switch (apiStatus)
                            {
                                case 200:
                                {
                                    if (respond is MessageObject result)
                                    {
                                        ...
                                        Methods.DialogPopup.InvokeAndShowDialog(this, GetText(Resource.String.Lbl_CheckYourEmail), GetText(Resource.String.Lbl_WeSentEmailTo).Replace("@", EmailEditext.Text), GetText(Resource.String.Lbl_Ok));
                                    }
