        ...
        public static void LoadImage(Activity activity, string imageUri, ImageView image, ImageStyle style, ImagePlaceholders imagePlaceholders, bool compress = false, RequestOptions options = null)
        {
            try
            {
                    ...
                    || imageUri.Contains("d-cover") || imageUri.Contains("d-avatar") || imageUri.Contains("f-avatar") || imageUri.Contains("user_anonymous"))
                {
                    ...
                    else if (imageUri.Contains("no_profile_female_image_circle"))
                        newImage.Load(Resource.Drawable.no_profile_female_image_circle).Apply(options).Into(image);
                    ...
                    else if (imageUri.Contains("no_profile_female_image") || imageUri.Contains("f-avatar"))
                        newImage.Load(Resource.Drawable.no_profile_female_image).Apply(options).Into(image);
